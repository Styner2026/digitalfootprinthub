// Live Blockchain Dashboard Component - Fixed Height Version
...
export default function BlockchainDashboard() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="min-h-[500px] max-h-[500px] overflow-y-auto custom-scrollbar p-1 transition-all duration-300 ease-in-out">
                {activeTab === 'verify' && (
